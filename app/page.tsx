...
export default function Home() {
    return (
        <main className="min-h-screen w-full overflow-hidden text-[#f0ede6]/80">
            <section className="mx-auto flex min-h-screen w-full max-w-8xl flex-col justify-center px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col items-center justify-center gap-6 py-18 text-center">
                    ...
                    <h1 className="max-w-5xl text-[clamp(2.25rem,6vw,6rem)] font-semibold leading-[0.95] tracking-[-0.04em]">
                        The simplest way to{" "}
                        <em className="not-italic text-[#AAFF00]/70">attend</em> tech{" "}
                        <em className="not-italic text-[#AAFF00]/70">events</em>
                    </h1>
